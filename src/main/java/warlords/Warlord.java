...
public class Warlord extends GameObject implements IWarlord {
	...
	public Warlord(int x, int y, Ages age, int index) {
		super(x, y, age, "/death.wav", Math.PI/2);
		this.width = 60;
		this.height = 85;
		...
		switch(index) {
			case 0:
				...
				spritePaths.put(Ages.SPACE, "/astronautBlue.png");
				break;
			case 1:
				...
				spritePaths.put(Ages.SPACE, "/astronautGreen.png");
				break;
			case 2:
				...
				spritePaths.put(Ages.SPACE, "/astronautRed.png");
				break;
			case 3:
				...
				spritePaths.put(Ages.SPACE, "/astronautYellow.png");
				break;
		}
	}
